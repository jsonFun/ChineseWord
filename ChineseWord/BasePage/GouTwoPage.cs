...
{
    public partial class GouTwoPage : Form
    {
        public GouTwoPage()
        {
            InitializeComponent();
        ...
        private void GouTwoPage_FormClosed(object sender, FormClosedEventArgs e)
        {
