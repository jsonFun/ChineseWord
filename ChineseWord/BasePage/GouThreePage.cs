...
{
    public partial class GouThreePage : Form
    {
        public GouThreePage()
        {
            InitializeComponent();
        ...
        private void GouThreePage_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int Height = this.Height;
            GouFourPage bs = new GouFourPage();
            bs.Height = Height;
            bs.Width = Width;
            bs.WindowState = this.WindowState;
            this.Hide();
